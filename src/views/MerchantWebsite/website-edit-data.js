      ...
      <div class="element-box function-element editable"
        ...
        <div class="slick">
          <div><img style="width:100%;height:100%;"
                    src="https://placem.at/places?w=375&h=200"></div>
        </div>
      </div>
    </div>
`,
  ...
  },
  {
    ...
    'componentName': '场馆介绍',
    'componentTpl': `
    <div class="component-wrap" style="position: relative; padding: 0 0.5rem">
      <div class="element-box text-element"
           style="text-align: center; opacity: 1; position: relative; height: 3.125rem; top: 1.8125rem; 
           font-size: 1rem">
        <span>场馆介绍</span>
      </div>
      <div class="element-box text-element"
           style="text-align: center; opacity: 1; position: relative; 
           height: 1.875rem; font-size: 0.8125rem; color: #808080">
      ...
      <div class="element-box drop-element" style="position: relative">
        ...
        style="text-align: center; width: 100%; height: 4.125rem;
        opacity: 1; font-size: 0.875rem; line-height: 1.25rem; 
        padding: 0.4375rem; position: relative; overflow: hidden"
             drop-id="drop_01" drop-height="34">
          <span>{{ introduce }}</span>
        </div>
        <div class="drop-element-button text-element drop-off"
             style="text-align: left; height: 4.0625rem; line-height: 4.0625rem; font-size: 
             0.8125rem; opacity: 1; padding: 0 0.4375rem; position: relative; top: 0.3125rem"
             drop-id="drop_01">
...
<div class="component-wrap" style="position: relative">
      <div class="component-inner">
        <div class="element-box text-element"
             style="text-align: center; opacity: 1; position: 
             relative; height: 3.125rem; top: 1.8125rem; font-size: 1rem">
          <span>教练</span>
        </div>
        <div class="element-box text-element"
             style="text-align: center; opacity: 1; position: 
             relative; height: 1.875rem; font-size: 0.8125rem; color: #808080">
          <span>Coach</span>
        </div>
        <div class="element-box drop-element"
             style="text-align: center; opacity: 1; position: relative; padding: 0 0.9375rem">
          <div class="drop-element-content text-element drop-off"
               style="text-align: left; width: 100%; height: 25.1875rem;
          ...
          <div class="drop-element-button text-element drop-off"
               ...
               line-height: 4.0625rem; font-size: 0.8125rem; opacity: 1; position: relative; top: 0.3125rem"
               drop-id="drop_03">
            <i class="iconfont"></i>
          </div>
        </div>
...
<div class="component-wrap" style="position: relative; background-color: #efefef; padding: 0 0.9375rem 1.25rem">
      <div class="component-inner">
        ...
        <div class="element-box text-element"
             style="text-align: left; opacity: 1; position: relative; 
